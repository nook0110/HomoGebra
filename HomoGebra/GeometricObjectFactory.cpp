...
ConstructedObjectFactory::ConstructedObjectFactory(Plane& plane) : plane_(plane)
{}

template <class GeometricObjectType>
std::shared_ptr<GeometricObjectType> ConstructedObjectFactory::GetNearestObject(
...
template std::shared_ptr<GeometricObject>
ConstructedObjectFactory::GetNearestObject(const sf::Vector2f& position,
                                           const float max_distance);
template std::shared_ptr<Point> ConstructedObjectFactory::GetNearestObject(
    const sf::Vector2f& position, const float max_distance);
template std::shared_ptr<Line> ConstructedObjectFactory::GetNearestObject(
    const sf::Vector2f& position, const float max_distance);
template std::shared_ptr<Conic> ConstructedObjectFactory::GetNearestObject(
    const sf::Vector2f& position, const float max_distance);